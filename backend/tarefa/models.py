...
class Tarefa(models.Model):
    ...
    status_tarefa = models.ForeignKey(StatusTarefa, on_delete=models.SET_NULL, null=True)
    aluno_profile = models.ForeignKey(AlunoProfile, on_delete=models.SET_NULL, null=True)
